...
model.load_state_dict(torch.load('data/models/isa/temp/isa_model_epoch_9', map_location=torch.device(args.device)))
...
run_isa_model_training(embeddings_graph, args.device, args.epochs, 'data/models/isa/temp', model, wn_reader, args.batch_size)